...
integration: $(MINISHIFT_BINARY)
	...
	go test -timeout 3600s $(REPOPATH)/test/integration --tags=integration -v -args --test-dir $(INTEGRATION_TEST_DIR) --binary $(MINISHIFT_BINARY) $(GODOG_OPTS) $(CUSTOM_TEST_FLAGS)
